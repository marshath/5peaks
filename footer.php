  ...
  <div class="container">
    <div class="row">
      <div class="span12">
        <div class="sponsors">
          <ul class="slides">
            <?php $sponsors = new WP_Query( 'post_type=sponsors&showposts=-1' ); ?>
    ...
    <div class="row">
      ...
      <div class="span12">
      	<ul class="social-menu">
      		<li><a href="http://facebook.com/5peaks">Facebook</a></li>
      		<li><a href="http://twitter.com/5PeaksRun">Twitter</a></li>
          ...
          <li><a href="http://www.instagram.com/5peaksrun">Instagram</a></li>
          ...
          <li><a href="/newsletter-sign-up/">Newsletter</a></li>
    		...
    		<ul class="footer-menu">
    			<?php wp_list_pages('sort_column=menu_order&depth=1&exclude=156,157,1033,1751&include=&title_li=');?><!-- <li class="page_item"><a href="http://5peakscollection.imagegroupinc.ca/">Store</a></li> -->
    		</ul>
        <p class="copyright">
          &#169; 5 Peaks Adventures Ltd.  <?php the_date('Y'); ?>. All rights reserved. | <a href="/privacy-policy/">Privacy Policy</a>
        </p>
      </div>
    </div> 
  </div>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-279258-17']);
